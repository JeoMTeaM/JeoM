...
if text == (Redis:get(TheJeoM.."JeoM:Name:Bot") or "بلاك بينك") then
local NamesBot = (Redis:get(TheJeoM.."JeoM:Name:Bot") or "بلاك بينك")
local NameBots = {
"ها "..NamesBot.. " شتريد؟",
"أჂ̤ أჂ̤ هياتني اني",
"موجود بس لتصيح",
...
local CmdStart = '*\n᥀︙أهلآ بك في بوت '..(Redis:get(TheJeoM.."JeoM:Name:Bot") or "بلاك بينك")..
